...
import Numbers from "../components/Keys/Numbers";
import Operator from "../components/Keys/Operator";
import Actions from "../components/Keys/Actions";
  ...
  render() {
    return (
      <div className="Calculator">
        ...
        <Operator onClick={this.handleInput} />
        <Numbers onClick={this.handleInput} />
        <Actions onClick={this.handleInput} />
      </div>
    );
  }
}
